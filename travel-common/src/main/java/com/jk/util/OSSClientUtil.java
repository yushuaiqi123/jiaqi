...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAI4FxLZ5VEpdAeSK1zDYei";
    private String accessKeySecret = "29Gc8mfBvtqm95hE7vXKIonyRQkf2z";
    // 空间
    private String bucketName = "1906b";
    // 文件存储目录
    private String filedir = "1906b/";
